    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="{{ route('client.trangchu', ['id' => 1]) }}" class="text-decoration-none">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                @if (Auth::user())
                    <a href="{{ route('view.cart', ['idUser' => Auth::user()->id]) }}" class="btn border">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light"
                    ...
                    <div class="navbar-nav w-100 overflow-hidden">
                        @foreach ($data as $item)
                            <a href="{{ route('client.allProductCate', ['id' => $item->id]) }}"
                                class="nav-item nav-link">{{ $item->cate_name }}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('client.trangchu') }}" class="nav-item nav-link">Home</a>
                            <a href="{{ route('client.allproduct') }}" class="nav-item nav-link active">Shop</a>
                        ...
                        @if (Auth::user())
                            <div class="navbar-nav ml-auto py-0">
                                <div class="navbar-nav ml-auto py-0">
                                    <a href="#" class="nav-item text-dark mr-5">Xin chào:
                                        {{ Auth::user()->name }}</a>
